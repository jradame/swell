...
export default function Progress() {
  ...
  return (
    <div style={{ padding: '32px 40px 48px', maxWidth: '960px' }}>
      ...
      {sessions.length === 0 ? (
        <div style={{
          background: 'var(--card)', borderRadius: 'var(--radius-lg)',
          border: '0.5px dashed var(--border-mid)', padding: '40px 20px', textAlign: 'center',
        }}>
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{
              ...
              color: streak > 0 ? 'var(--primary)' : 'var(--text-muted)',
            ...
            <div>
              ...
              <div style={{ fontSize: '12px', color: 'var(--text-muted)', marginTop: '4px' }}>
                {streak > 0 ? 'Keep it going' : 'Log a session today to start a streak'}
              </div>
            </div>
          </div>
          ...
          <div style={{
            background: 'var(--card)', borderRadius: 'var(--radius-lg)',
            border: '0.5px solid var(--border)', padding: '16px', marginBottom: '16px',
          }}>
            <div style={{
            ...
            <div style={{ display: 'flex', align: 'flex-end', gap: '12px', height: '80px', alignItems: 'flex-end' }}>
              {monthlyData.map((m, i) => (
                <div key={i} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
                  ...
                  <div style={{
                    width: '100%',
                    height: m.count > 0 ? `${Math.max((m.count / maxMonthly) * 52, 6)}px` : '4px',
                    background: i === 3 ? 'var(--primary)' : 'var(--primary-dim)',
                    borderRadius: '4px 4px 0 0',
                    border: m.count === 0 ? '0.5px solid var(--border)' : 'none',
